...
in_img_type="TF_M"
in_aes_key=$data_dir/keys/SCGK_RTOS.bin
in_iv=$data_dir/parameters/iv_rtos.bin
in_signing_key=$data_dir/keys/K1_NSPE_A.rsa.priv.pem
in_seg_id=0x00000000
in_seg_id_mask=0xFFFFFFFF
in_version=0x00000000
in_version_mask=0xFFFFFFFF
in_extras=$data_dir/parameters/in_rtos_extras.bin
in_payload_length=0x0
in_payload=$data_dir/in_dummy_rtos.bin
out_TF_M=$out_dir/out_rtos.bin
