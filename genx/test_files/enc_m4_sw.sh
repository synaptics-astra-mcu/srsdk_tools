...
in_img_type="TF_M"
in_aes_key=$data_dir/keys/SCGK_M4_SW.bin
...
in_extras=$data_dir/parameters/in_m4_sw_extras.bin
in_payload_length=0x0
in_payload=$data_dir/in_dummy_m4_sw.bin
out_TF_M=$out_dir/out_m4_sw.bin
