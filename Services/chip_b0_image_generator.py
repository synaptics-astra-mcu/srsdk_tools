    ...
    try:       
        ...
        if os.path.exists(absolute_path):        
            ...
            for section_info in section_infos:
                ...
                if not image_gen_config.is_sdk_secured:   
                    run_Genx_non_secured(info_dict['Priv_Key_Path'], input_section_name_file, output_genx_fw_bin_file, fw_type)                    
                else:                                
                    run_Genx_secured(info_dict, len(section_data), input_section_name_file, output_genx_fw_bin_file)
